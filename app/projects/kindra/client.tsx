...
const KINDRA_COPY = {
  ...
  description:
    "Production-ready e-commerce foundation for fashion brands. Separate Men's and Women's storefronts, multi-variant products, Stripe payments, inventory management, and a full admin dashboard — ready to deploy.",
  longDescription:
  ...
  solution:
    'A ready-to-deploy starter kit with all the common features baked in — storefronts, admin, payments, and image hosting.',
  keyFeatures: [
          ...
          <article className="space-y-28">
            ...
            >
              <div className="mb-8 flex items-center gap-3">
                ...
                <p className="text-xs uppercase tracking-[0.3em] text-stone-500">{KINDRA_COPY.category}</p>
              </div>
              <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                <div>
                  ...
                  <p className="mt-6 text-lg leading-8 text-stone-300">{KINDRA_COPY.longDescription}</p>
                </div>
                <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6">
                  ...
                  <p className="text-sm leading-7 text-stone-400">{KINDRA_COPY.problem}</p>
                  ...
                  <p className="text-sm leading-7 text-stone-400">{KINDRA_COPY.solution}</p>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {KINDRA_COPY.keyFeatures.map((feature) => (
              ...
              <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
                <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
                  <div>
                    ...
                    <h3 className="mt-3 text-2xl font-semibold">{MENUQR_COPY.title}</h3>
                    <p className="mt-3 max-w-xl text-sm leading-7 text-stone-400">{MENUQR_COPY.description}</p>
                  </div>
                  <Link
